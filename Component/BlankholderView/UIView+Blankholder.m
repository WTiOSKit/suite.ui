...
// 代理
- (void)setBlankholderDataSource:(id<UIBlankholderDataSource>)blankholderDataSource {
...
- (id<UIBlankholderDataSource>)blankholderDataSource {
...
- (void)reloadBlankholderView {
    ...
    if ([self itemCount] > 0) {
        ...
        if ([self.blankholderDataSource conformsToProtocol:@protocol(UIBlankholderDataSource)]
