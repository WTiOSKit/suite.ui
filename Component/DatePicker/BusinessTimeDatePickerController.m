...
- (void)initViews {
    ...
    [self.cancelButton setTitleColor:[UIColor fontDeepBlackColor] forState:UIControlStateNormal];
    ...
    [self.selectButton setTitleColor:[UIColor fontDeepBlackColor] forState:UIControlStateNormal];
