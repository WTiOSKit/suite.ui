    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            // TextInsets
            {
                ...
                if (idx == 0) {
                    backgroundLayerRect = CGRectMake(PIXEL_5, PIXEL_5, self.segmentWidth-PIXEL_5, self.height-PIXEL_5*2);
                } else {
                    backgroundLayerRect = CGRectMake(self.segmentWidth*idx+2.5f, PIXEL_5, self.segmentWidth-PIXEL_5, self.height-PIXEL_5*2);
                }
