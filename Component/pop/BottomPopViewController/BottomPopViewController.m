...
@interface BottomPopViewController ()
...
- (void)addBottomPopoverVC:(BottomPopViewController *)bottomPopoverVC {
    @synchronized (g_bottomPopupVCArray) {
        [g_bottomPopupVCArray addObject:bottomPopoverVC];
    }
}

- (void)removeBottomPopoverVC:(BottomPopViewController *)bottomPopoverVC {
    @synchronized (g_bottomPopupVCArray) {
