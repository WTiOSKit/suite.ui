...
/**
 *  第一步：
 *      #import "UIView+Blankholder.h", 设置<UIBlankholderDataSource>
...
@protocol UIBlankholderDataSource;
 ...
 */
@property(nonatomic, weak)id <UIBlankholderDataSource> blankholderDataSource;
...
@protocol UIBlankholderDataSource <NSObject>
