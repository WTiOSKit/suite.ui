...
+ (void)adaptPhone4s:(Block)phone4sBlock phone5s:(Block)phone5sBlock phone6:(Block)phone6Block phone6p:(Block)phone6pBlock {
    ...
    if ([DeviceUtil hardware]==IPHONE_4||[DeviceUtil hardware]==IPHONE_4_CDMA||[DeviceUtil hardware]==IPHONE_4S) {
        
        if (phone4sBlock) {
            phone4sBlock();
        }
        
    }else if ([DeviceUtil hardware]==IPHONE_5||[DeviceUtil hardware]==IPHONE_5_CDMA_GSM||[DeviceUtil hardware]==IPHONE_5C||[DeviceUtil hardware]==IPHONE_5C_CDMA_GSM||[DeviceUtil hardware]==IPHONE_5S||[DeviceUtil hardware]==IPHONE_5S_CDMA_GSM){
        
        if (phone5sBlock) {
            phone5sBlock();
        }
        
    }else if ([DeviceUtil hardware]==IPHONE_6 || [DeviceUtil hardware] == IPHONE_6S){
        
        if (phone6Block) {
            phone6Block();
        }
        
    }else if ([DeviceUtil hardware]==IPHONE_6_PLUS  || [DeviceUtil hardware] == IPHONE_6S_PLUS){
...
+ (void)adapterPad1024:(Block)pad1024Block pad2048:(Block)pad2048Block {
    NSUInteger hardwareDevice = [DeviceUtil hardware];
