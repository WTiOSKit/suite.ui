...
static NSString *backButtonImageName = @"top_backbutton";
/**
 *  Usage
 
 *  这个的有效条件：
 *  1. userPreferredStatusBarStyle 设置好
 *  2. 使用 BaseNavigationController
 */
static UIStatusBarStyle userPreferredStatusBarStyle = UIStatusBarStyleLightContent;
...
- (void)initDefault {
    ...
    self.userPreferredStatusBarStyle = userPreferredStatusBarStyle;
...
- (UIStatusBarStyle)preferredStatusBarStyle {
    return self.userPreferredStatusBarStyle;
}
...
+ (void)setUserPreferredStatusBarStyle:(UIStatusBarStyle)statusBarStyle {
    userPreferredStatusBarStyle = statusBarStyle;
}
...
@implementation BaseViewController ( Handler )
