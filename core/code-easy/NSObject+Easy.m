...
- (void)showAlertView:(NSString *)title message:(NSString *)message cancelButtonName:(NSString *)name cancelHandler:(Block)cancelHandler {
    ...
    XIAlertView *alertView = [[XIAlertView alloc] initWithTitle:title message:message cancelButtonTitle:nil];
    [alertView addButtonWithTitle:name style:XIAlertActionStyleCancel handler:^(XIAlertView *alertView, XIAlertButtonItem *buttonItem) {
        if (cancelHandler) {
            cancelHandler();
        }
...
+ (void)showAlertView:(NSString *)title message:(NSString *)message cancelButtonName:(NSString *)name {
    XIAlertView *alertView = [[XIAlertView alloc] initWithTitle:title message:message cancelButtonTitle:name];
    [alertView show];
